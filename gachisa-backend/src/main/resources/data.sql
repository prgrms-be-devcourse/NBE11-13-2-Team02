...
INSERT INTO user (email, password, name, role, created_at) VALUES
...
INSERT INTO product (seller_id, category_id, name, description, base_price, status, created_at) VALUES
                                                                                                    (3, 1, '텀블러 6종 세트', '보온·보냉 겸용 텀블러 6종 구성', 18000, '판매중', NOW()),
                                                                                                    (3, 2, '유기농 원두 1kg', '싱글 오리진 원두', 16000, '판매중', NOW());

INSERT INTO product_option (product_id, option_name, option_value, stock) VALUES
                                                                              (1, '기타', '기본', 100),
                                                                              (2, '기타', '기본', 100);

INSERT INTO group_buy (product_id, product_option_id, target_count, current_count, discount_rate, open_at, deadline, status, version) VALUES
                                                                                                                                          (1, 1, 10, 7, 0.30, NOW(), DATE_ADD(NOW(), INTERVAL 2 DAY), '모집중', 0),
                                                                                                                                          (2, 2, 8,  2, 0.20, NOW(), DATE_ADD(NOW(), INTERVAL 3 DAY), '모집중', 0);
